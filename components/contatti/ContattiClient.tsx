    ...
    it: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: 'È previsto un deposito cauzionale?', a: 'Sì, verrà richiesto un deposito cauzionale all\'arrivo. L\'importo esatto varia da casa a casa ed è indicato sul nostro sito.\nAll\'arrivo sarà richiesta una carta di credito (non Debit Card, non PostePay). Il deposito sarà restituito integralmente entro 48 ore dalla partenza in assenza di danni.' },
    ...
    en: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: 'Is a security deposit required?', a: 'Yes, a security deposit will be required on arrival. The exact amount varies by property and is shown on our website.\nA credit card will be required on arrival (not Debit Card, not PostePay). The deposit will be fully refunded within 48 hours of departure if there is no damage.' },
    ...
    de: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: 'Wird eine Kaution verlangt?', a: 'Ja, bei der Ankunft wird eine Kaution verlangt. Der genaue Betrag variiert je nach Unterkunft und ist auf unserer Website angegeben.\nBei der Ankunft wird eine Kreditkarte benötigt (keine Debitkarte, keine PostePay). Die Kaution wird innerhalb von 48 Stunden nach der Abreise vollständig zurückerstattet, sofern keine Schäden vorliegen.' },
    ...
    pl: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: 'Czy wymagana jest kaucja?', a: 'Tak, przy przyjeździe wymagana jest kaucja. Dokładna kwota różni się w zależności od obiektu i jest podana na naszej stronie.\nPrzy przyjeździe wymagana jest karta kredytowa (nie karta debetowa, nie PostePay). Kaucja zostanie w pełni zwrócona w ciągu 48 godzin od wyjazdu, jeśli nie ma żadnych szkód.' },
...
function FaqItem({ item }: { item: FaqItem }) {
  ...
  return (
    <div style={{ borderBottom: '0.5px solid #e5e7eb' }}>
      ...
      >
        <span style={{ fontSize: 15, color: '#111', lineHeight: 1.45, flex: 1 }}>
          {item.q}
        </span>
        <svg
          width="20" height="20"
      ...
      <div style={{
        ...
        borderTop: open ? '0.5px solid #f3f4f6' : 'none',
...
// ─── Canali contatto ──────────────────────────────────────────────────────────
function ContactChannels({ locale, t, compact }: {
  locale: Locale;
  t: typeof UI['it'];
  compact?: boolean;
}) {
  ...
  const channels = [
    {
      ...
      bg: '#dcf5e8', label: t.wa, sub: t.waSub,
      icon: (
    ...
    {
      href: PHONE,
      bg: '#eff6ff', label: t.tel, sub: t.telSub,
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#1E73BE" strokeWidth="2">
    ...
    {
      href: EMAIL,
      bg: '#f9fafb', label: t.mail, sub: t.mailSub,
      icon: (
  ...
  return (
    <div style={{
      ...
      border: compact ? 'none' : '0.5px solid #e5e7eb',
      overflow: 'hidden',
    }}>
      {!compact && (
        <div style={{
      ...
      {channels.map(ch => (
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <p style={{ margin: 0, fontSize: 16, fontWeight: 600, color: '#111' }}>{ch.label}</p>
            <p style={{ margin: '1px 0 0', fontSize: 12, color: '#9ca3af' }}>{ch.sub}</p>
          </div>
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 0 40px' }}>
      ...
      <div style={{
        ...
        {faqData.map((cat, ci) => (
          <div key={ci} style={{ background: '#fff', marginBottom: 8 }}>
      ...
      <div style={{ padding: '0 12px 12px' }}>
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: 14, color: '#1E73BE', lineHeight: 1.4, fontWeight: 500 }}>
            {t.bookBanner}
          </p>
          <a
            href={bookHref}
