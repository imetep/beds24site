    ...
    <div style={{ borderTop: '0.5px solid #e5e7eb' }}>
      <button
        ...
        style={{
          ...
          gap: 16, cursor: 'pointer', textAlign: 'left', minHeight: 56,
        }}
      >
        <span style={{ fontSize: 15, color: '#111', lineHeight: 1.4, flex: 1, fontWeight: 500 }}>
          {title}
        </span>
...
function RateCard({ label, value }: { label: string; value: string }) {
  return (
    <div style={{
      ...
      <p style={{ margin: 0, fontSize: 11, color: '#9ca3af', marginBottom: 3 }}>{label}</p>
      <p style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111' }}>{value}</p>
    </div>
  );
}
...
export default function UtenzeClient({ locale }: Props) {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 0 60px' }}>
      ...
      {/* ── Hero ────────────────────────────────────────────────────────────── */}
      <div style={{ background: '#fff', padding: '28px 20px 20px', borderBottom: '0.5px solid #f3f4f6', marginBottom: 8 }}>
      ...
      <div style={{ background: '#fff', padding: '14px 20px', marginBottom: 8, borderBottom: '0.5px solid #f3f4f6' }}>
        <p style={{ margin: 0, fontSize: 12, color: '#6b7280', lineHeight: 1.6 }}>
          {t.disclaimer}
        </p>
      </div>

      {/* ── Tariffe — sempre visibili ────────────────────────────────────────── */}
      <div style={{ background: '#fff', padding: '16px 20px 18px', marginBottom: 8 }}>
      ...
      {/* ── Toggle stagione ──────────────────────────────────────────────────── */}
      <div style={{ background: '#fff', padding: '14px 20px', marginBottom: 8 }}>
        ...
        <button
          ...
          style={{
            ...
            border: isWinter ? 'none' : '0.5px solid #e5e7eb',
            cursor: 'pointer', fontSize: 14, fontWeight: isWinter ? 600 : 400,
      ...
      <div style={{ background: '#fff', marginBottom: 8 }}>
        ...
        <div style={{ padding: '20px 20px 0' }}>
          ...
          <p style={{ margin: '0 0 16px', fontSize: 14, color: '#4b5563', lineHeight: 1.7 }}>
          ...
          <div style={{
            ...
            border: `0.5px solid ${isWinter ? '#FDE68A' : '#FDE047'}`,
          }}>
            <p style={{ margin: '0 0 8px', fontSize: 12, fontWeight: 600, color: isWinter ? '#633806' : '#713f12' }}>
              {isWinter ? t.wCostLabel : t.sCostLabel}
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8 }}>
                <span style={{ fontSize: 13, color: isWinter ? '#854F0B' : '#713f12' }}>
                  {isWinter ? t.wCostCareful : t.sCostCareful}
                </span>
                <span style={{ fontSize: 14, fontWeight: 700, color: isWinter ? '#633806' : '#713f12', whiteSpace: 'nowrap' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 14, fontWeight: 700, color: '#c00', whiteSpace: 'nowrap' }}>
      ...
      <div style={{
        ...
        borderLeft: '3px solid #1E73BE', borderRadius: 0,
        padding: '18px 20px',
      }}>
        <p style={{ margin: '0 0 8px', fontSize: 15, fontWeight: 700, color: '#1E73BE' }}>
          {t.honestTitle}
        </p>
