...
// RangeCalendar ora vive in components/admin/RangeCalendar.tsx,
// importato in cima al file. Lo stesso componente è usato anche dalla
// vista check-out per coerenza visuale.
