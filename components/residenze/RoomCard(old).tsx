...
const LABELS: Record<string, Record<string, string>> = {
  it: {
    ...
    privatePool: '🏊 Piscina privata', sharedPool: '🌊 Piscina condivisa', noPool: '🏖️ Senza piscina',
  ...
  en: {
    ...
    privatePool: '🏊 Private pool', sharedPool: '🌊 Shared pool', noPool: '🏖️ No pool',
  ...
  de: {
    ...
    privatePool: '🏊 Privater Pool', sharedPool: '🌊 Gemeinschaftspool', noPool: '🏖️ Kein Pool',
  ...
  pl: {
    ...
    privatePool: '🏊 Prywatny basen', sharedPool: '🌊 Wspólny basen', noPool: '🏖️ Bez basenu',
