...
export default function AdminPage() {
  ...
  const sezioni: Sezione[] = [
    ...
    },
    {
      ...
      desc: 'Gestione operatori, strutture, checklist, smistamento turnover, segnalazioni e setup Telegram. Tutto il flusso operativo in un unico hub.',
      href: '/admin/operativita',
      color: '#0ea5e9',
    },
    {
